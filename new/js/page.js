  ...
  (function(){//云动画
    ...
    (function (){
        var page = document.getElementById("page_choose"),
            opage_ul = document.getElementById("page_ul"),
    ...
    (function (){
        var anpage = document.getElementById("an_page_choose"),
            anopage_ul = document.getElementById("an_page_ul"),
            oanpage = anpage.getElementsByTagName("div"),
